...
As a final note, for formatting purposes most dataframe outputs have the following code after it `%>% nice_format()` to make the output nicer in the html file, you can ignore this, it is just for the purpose of the output document.
